...
def header():
    col1, col2, col3, _ = st.columns([5, 1, 3, 5])
    col1.image("static/mag_logo.png")
    col2.markdown("## ×")
    ...
    st.markdown(
        """Welcome! 👋 This is a simple example on using Streamlit as the UI for your Autogen agents .
